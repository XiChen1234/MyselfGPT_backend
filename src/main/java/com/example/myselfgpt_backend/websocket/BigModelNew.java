...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "08f43532";
    public static final String apiSecret = "YzViNDIwZGYzMDM5NTRlNWQ4NzRlYzc5";
    public static final String apiKey = "1e14553c25dce596bcf72a0b578444e1";
    ...
    public static boolean stopFlag = true; // 停止标志，如果为true标识所有输出全部停止；为false标识还未全部输出
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true){
            if(totalFlag){
                ...
                for (int i = 0; i < 1; i++) {
                    totalAnswer="";
                    okhttp3.WebSocket webSocket = client.newWebSocket(request, new BigModelNew(i + "",
                            false));
                }
            }else{
                Thread.sleep(200);
    ...
    public static void runModel(String text) throws Exception {
        stopFlag = false;
        if(totalFlag){
            NewQuestion=text;
            // 构建鉴权url
    ...
    public static String getTotalAnswer() {
        return totalAnswer;
    }
